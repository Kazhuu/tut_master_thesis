...
Kuinka IED-laitteet ja etäohjelmistot kommunikoivat keskenään, sen kertoo maailmanlaajuisesti määritetty IEC 61850 -standardi. Standardin tarkoitus on asettaa yhteiset säännöt, jotta eri valmistajien laitteet olisivat yhteensopivia keskenään. Dokumenteissa standardin on määritetty tekniikasta riippumattomaksi, joka erikseen mallinnetaan halutulle tekniikalle. Tässä työssä standardin mukaista kommunikointia käytetään MMS-protokollan päällä. 
...
% Standardin luokkat ja niistä muodostuva hierarkia.
