...
\end{itemize}
Käsiteet muodostavat mallista hiearkisen puurakenteen ja ne on listattu hiearkisessa järjestyksessä. Puun juurena on fyysinen laite, sen alla voi olla yksi tai enemmän loogista laitetta, loogisen laitteen alla yksi tai enemmän loogista noodia jne. Käsitteillä standardissa virtualisoidaan aseman funktiot, esimerkiksi suojaus. Kuvassa \ref{fig:substation-abstraction} on esitetty, kuinka sähköaseman fyysinen sähkölinjan katkaisija voidaan mallintaa standardin määrittämillä käsitteillä. Kuvassa aseman fyysiset katkaisija ja niiden oheislaitteet mallinetaan ensin loogiseksi laitteeksi, esimerkiksi yhden jännitetason katkaisijat. Jokainen loogisen laitteen katkaisija mallinnetaan loogiseksi noodiksi. Jotta oikeaa fyysistä katkaisijaa voidaan kuvata mallilla. Täytyy siitä pystyä esittämään mitattavia tai kuvaavia arvoja, esimerkiksi missä tilassa katkaisija on. Näihin tarkoituksiin käyteään käsitteitä dataobjekti ja data-attribuutti. Looginen noodi koostuu dataobjekteista ja dataobjekti koostuu data-attribuuteista. Data-attribuutti on esittää jotakin arvoa laitteesta, esimerkiksi katkaisijan tila. Dataobjekti on tapa koostaa yhteen kuuluvat data-attribuutit saman käsitteen alle.
