...
Loogisen noodin luokan kentät, kuten Pos, rakentuvat standardin yleisistä luokista (engl. Common Data Class, lyhennetään CDC). CDC-luokat ovat luokkia jotka sisältävät data attribuutteja, ja ovat yhteisiä monelle eri loogisen noodin luokalle. CDC-luokkien määritykset löytyy standardin osasta 7-3. Taulukossa \ref{tab:iec61850-CDP-class-definition} on esitetty Pos-attribuutin, DPC-luokan määritys (enlg. controllable double point).

\begin{table}[ht!]
	\caption{IEC 61850 -standardin CDP-luokan määritys \cite[s.~44]{IEC61850-7-3}.}
	\label{tab:iec61850-CDP-class-definition}
	\begin{tabular}{l | l | l }
		\hline
		\textbf{Data attribuutin nimi} & \textbf{FC} & \textbf{Liipaisin} \\
		\hline
		\multicolumn{3}{l}{\textbf{}} \\
		\hline
		CBTmms & Closing time of braker & ING \\
		\hline
	\end{tabular}
\end{table}
