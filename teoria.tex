...
\begin{figure}
	\includegraphics[width=1\textwidth]{pictures/iec61850-urcb-communication.png}
	\caption{Puskuroitu viestien tilausprosessi asiakkaan ja serverin välillä.}
	\label{fig:iec61850-urcb-communication}
\end{figure}
