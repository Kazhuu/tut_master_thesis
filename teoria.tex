...
\begin{itemize}
	...
	\item \emph{hajautusvaihde} (engl. \emph{fanout exchange}),
	\item \emph{aihepiirivaihde} (engl. \emph{topic exchange}) ja
	\item \emph{otsikkovaihde} (engl. \emph{header exchange}).
\end{itemize}
