...
% TODO: Jono hyvä puoli on viestin lähettämisen takuu. Viesti on identtinen alkuperäiseen ja se lähetetään vai kerran.
% TODO: Vertaa tätä suoraan viestin välittämiseen missä voi kans olla jonot käytössä. Kerro mikä erottaa tämän parhaiten tästä \cite[s.~256]{distributed-systems-concepts-and-design}.
