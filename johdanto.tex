...
\begin{itemize}
	...
	\item IED-laitteelta haluttu tiedon määrä voi vaihdella ajojen välillä,
	\item tiedon välityksen tekniikka täytyy tukea verkkopalvelun tapauksessa TCP/IP-pro\-to \-kol\-la\-mää\-ri\-tyk\-si\-ä, ja
	\item tiedonsiirrossa lähetystakuu ei ole vältämätön.
\end{itemize}

Osa vaatimuksista tulevat muun järjestelmän toimintaperiaatteista ja kuinka sitä käytetään. Käyttäjän on tarkoitus ohjata tiedon saantia ja sen määrää sähköasemilta käyttöliittymän kautta. Tästä seurauksena vaatimus jossa muu järjestelmä ohjaa tiedon hakua ja sen määrää. Uusien järjestelmän komponenttien kehitys halutaan pitää helppona. Tämä myös tarkoittaa tilannetta jossa komponentti tarvitsee tietoa IED-laitteelta. Tietoa on helpomi käsitellä kun siitä saadaan ilmoituksia uuden tiedon saapuessa. Tieto puskuroidaan kun sitä ei ehditä käsitellä. Ja tiedon esitystapa on helppo lukea eri tekniikoilla. Kaikki edellä mainitut helpottavat komponentin kehittäjää ja tiedon käsittelyä. %TODO: Kirjoita tähän tiedon jaottelusta ja sen jälkeen muista.

% TODO: Avaa vaatimuksia enemmän. Mitä esim. tarkoittaa viestien jakaminen lähteen mukaan. Annan konkreettinen esimerkki ja miksi joitakin vaatimuksia on asetettu.
% TODO: Kirjoita takuista tähän auki mitä tarkoitetaan.
% TODO: Viestien jaon periaattena on erottaa eri asemien IED:t toisistaan.
