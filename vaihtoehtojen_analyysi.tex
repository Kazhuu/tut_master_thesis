...
% TODO: Tarkista ylläoleva teksti ja jatka jaa teksti tämän jälkeen niin, että ensin käyt läpi suorat ja epäsuorat paradigmat omina kappaleinaan. Näistä lukija saa kuvan mitkä paradigmat sopivat ja mitkä eivät.
...
% TODO: Kirjoita loppuun yhteenveto kuten aikaisemmin missä käsitellään tulokset ja mitä vielä on vastaamatta. Tämä toimii pohjana kun seuraavaksi verrataan kommunikointitekniikoita keskenään.
