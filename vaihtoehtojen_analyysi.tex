...
% TODO: Kirjoita tämä kappale vastaamaan loppua kun muut teksit on kirjoitettu kokonaan.

% TODO: Kirjoita loppuun yhteenveto kuten aikaisemmin missä käsitellään tulokset ja mitä vielä on vastaamatta. Tämä toimii pohjana kun seuraavaksi verrataaan kommunikointitekniikoita keskenään.
...
% TODO: Voisiko ylempiä kappaleita yhdistää. Samaa asiaa toistetaan molemmista ja samoista syistä eivät sovi toteutukseen. Jakaa kirjoitus suoriin ja epäsuoriin paradigmoihin.
...
% TODO: Kirjoita alla olevien mukaan miksi viestijono ja pub/sub ovat parhaat vaihtoehdot tilanteeseen.
