...
\begin{it}
	Piirrä UML-sekvenssikaatio yhteyden avaamisesta ja mitä funktioita kutsutaan missäkin järjestyksessä. Avaa tämä sit tekstiin.
\end{it}
Parametrien luvun jälkeen ohjelma muodosti yhteydet ensin RabbitMQ-palvelimelle ja sen jälkeen IED-laitteelle.
