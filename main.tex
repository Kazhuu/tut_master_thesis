...
\include{johdanto}
\include{mms-protokolla}
\include{iec61850-standardi}
\include{advanced-message-queuing-protocol}
\include{lahtokohdat-ja-tarve}
\include{toteutettavan-arkkitehtuurin-suunnittelu}
\include{ohjelmiston-toteutus}
\include{tilaava-asiakasohjelmisto}
\include{yhteenveto-ja-tulokset}
